...
<div id="oc-posts" class="owl-carousel posts-carousel carousel-widget posts-md" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="4">
        ...
        <?php
            $sql = "SELECT * FROM offers as o LEFT OUTER JOIN analysis as s on o.id = s.id";
        ...
        <div class="entry">
            <div class="entry-image">
                <a href="booking.php?id=<?php echo $row['id'];?>" data-lightbox="image"><img src="<?php echo $row['picture'];?>"></a>
            </div>
            ...
            <div class="entry-meta">
                <ul>
                    <li><span class="me-5"><?php echo $row['discount']?></span><strike><?php echo $row['price']?></strike></a></li>
                    
                </ul>
            </div>
            <div class="entry-content">
                <p><?php echo $row['m3mal_name']?></p>
            </div>
            </div>
    </div>
            <?php
        ...
        <div class="container clearfix">
         ...
         <div class="entry col-md-4 col-sm-6 col-12">
                    <div class="grid-inner">
                        <div class="entry-image">
                            <a href="booking.php?id=<?php echo $row['id'];?>"><img src="<?php echo $row['picture'];?>" alt="Standard Post with Image"></a>
                        </div>
                        <div class="entry-title">
                            <h2><a href="blog-single.php"><?php echo $row['analysis_name'];?></a></h2>
                        </div>
                        <div class="entry-meta">
                            <ul>
                                <li><span class="me-5"><?php echo $row['discount'];?></span></a><strike><?php echo $row['price']?></strike></li>
                            </ul>
                        </div>
                        <div class="entry-content">
                            <p><?php echo $row['m3mal_name'];?></p>
