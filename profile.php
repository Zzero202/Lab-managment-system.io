...
<section id="content">
    ...
    <tr>
      ...
      <th class="text-center col-1">phone</th>
      <th class="text-center col-1">password</th>
      <th class="text-center col-1">edition</th>
...
?>
    <tr>
      <td class="text-center col-1"><?php echo $data['name']?></td>
      <td class="text-center col-1"><?php echo $data['email']?></td>
      <td class="text-center col-1"><?php echo $data['phone']?></td> 
      <td class="text-center col-1">password</td> 
      <td class="text-center col-1"><a href="edit.php?id=<?php echo $data['id']; ?>" >Edit</a></td>
